...
(function(global){
  ...
  const writingExtensions = {
    ...
    9:[["Đặt một câu tiếng Trung có từ “希望”。","我希望明天能做完作业。","Đặt câu với từ trọng tâm","希望 cần dẫn nội dung em mong muốn."],["Sau giờ tự học, em kể lại cho bạn. Viết đúng 2 câu tiếng Trung. Câu 1 nói em bắt đầu từ câu thứ nhất. Câu 2 nói em đã làm xong nhưng có một câu sai.","我从第一题开始做。后来我做完了，但是有一道题做错了。","Kể lại tiến trình theo dữ kiện","Viết đủ điểm bắt đầu, kết quả và một lỗi cụ thể."]],
    ...
    hsk2_bai9_tidu:{
      ...
      writing:{
        ...
        tasks:[
          ...
          ["Sau giờ tự học, em nhắn cho bạn cùng lớp. Viết đúng 2 câu tiếng Trung. Câu 1 nói em bắt đầu làm từ câu thứ nhất. Câu 2 nói vì bài quá nhiều nên em vẫn chưa làm xong.","我从第一题开始做。题太多了，我还没做完。","Tường thuật tiến trình theo dữ kiện","Viết đủ hai ý đã cho; không cần thêm tình tiết khác.",null],
          ["Viết một lời chào mừng ngắn cho một bạn mới vào lớp.","欢迎你来我们班！","Chào đón người mới","Dùng 欢迎 đúng đối tượng.",null],
          ["Hôm qua em làm sai hai câu. Viết một tin nhắn đúng 3 câu tiếng Trung cho bạn. Câu 1 nêu số câu làm sai. Câu 2 nói ngày mai em sẽ làm lại. Câu 3 nhờ bạn giúp.","我做错了两道题。明天我想再做一遍。你能帮助我吗？","Nhắn tin giải quyết lỗi học tập theo dữ kiện","Ba câu lần lượt nêu lỗi, kế hoạch và lời nhờ.","准确 40%: đủ số câu làm sai và kế hoạch.\n连贯 25%: ba ý theo trình tự rõ.\n得体 20%: lời nhờ lịch sự.\n自然 15%: dùng 做错、再做 tự nhiên."]
        ],
