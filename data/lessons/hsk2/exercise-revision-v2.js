...
(function(global){
  ...
  const writingExtensions = {
    ...
    13:[["Đặt một câu tiếng Trung có từ “一直”。","请一直往前走。","Đặt câu với từ trọng tâm","一直 diễn tả hành động kéo dài hoặc đi thẳng liên tục."],["Chỉ đường từ lớp học đến một nơi gần đó.","一直往前走，到路口左转。再走五分钟就到宾馆了。","Chỉ đường theo trình tự","Có hướng đi và ít nhất một mốc đường."]],
    14:[["Đặt một câu tiếng Trung có từ “过”。","我去过北京一次。","Đặt câu về trải nghiệm","Câu nói một trải nghiệm đã có."],["Kể về một buổi cuối tuần, nêu thời tiết và một hoạt động em đã làm.","周末天气很晴，我和朋友去公园玩儿。虽然有点儿热，但是很有意思。","Kể lại trải nghiệm","Có thời gian, hoạt động và cảm nhận."]],
    15:[["Đặt một câu tiếng Trung có từ “更”。","我觉得晴天更好。","Đặt câu so sánh mức độ","Câu cần cho thấy lựa chọn hoặc so sánh rõ ràng."],["Viết một tin nhắn về kế hoạch về nhà vào dịp năm mới.","新年就要到了，我已经买好火车票了。明天我去火车站。","Viết tin nhắn theo kế hoạch","Có thời điểm, kế hoạch và ít nhất một thông tin cụ thể."]]
  };
  ...
  const lessons = {
    hsk2_bai8_rangwo:{
      ...
      writing:{
        ...
        tasks:[
          ["Bạn chưa quyết định có mua chiếc áo đắt. Viết một tin nhắn ngắn cho nhân viên bán hàng.","这件衣服有点儿贵，让我想想，明天再告诉你。","Nói hoãn quyết định", "Câu cần có lý do ngắn và kế hoạch trả lời sau.","准确 40%: có 贵、想想 hoặc 再告诉。\n连贯 25%: lý do trước, kế hoạch sau.\n得体 20%: lịch sự với nhân viên.\n自然 15%: trật tự câu tự nhiên."],
          ...
          ["Kể bằng tiếng Trung bạn đã xem quần áo màu gì và chưa quyết định điều gì.","我看了一件白色的衣服。可是有点儿贵，我还没决定。","Kể lại lựa chọn đơn giản","Có ít nhất hai ý liên quan đến màu sắc và quyết định.",null],
          ...
          ["Viết một tin nhắn hỏi một người bạn có rảnh đi ăn không. Nếu bạn ấy bận, hãy đề nghị ngày khác.","你明天晚上有时间吗？我们一起吃饭，好吗？如果你有事，我们明天再说。","Tin nhắn theo tình huống","Đánh giá ý mời, hỏi ý kiến và cách phản hồi mềm mại.","准确 40%: đủ lời hỏi và lời đề nghị.\n连贯 25%: trình tự rõ.\n得体 20%: lịch sự với bạn.\n自然 15%: không dịch từng chữ từ tiếng Việt."]
        ],
