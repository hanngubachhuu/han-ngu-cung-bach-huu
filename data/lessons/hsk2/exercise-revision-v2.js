...
(function(global){
  ...
  const writingExtensions = {
    ...
    9:[["Đặt một câu tiếng Trung có từ “希望”。","我希望明天能做完作业。","Đặt câu với từ trọng tâm","希望 cần dẫn nội dung em mong muốn."],["Giới thiệu việc học của em:\nMột bạn mới quen hỏi em bắt đầu học tiếng Trung từ khi nào và gần đây em đang học thế nào. Hãy viết 3–4 câu trả lời tự nhiên bằng tiếng Trung.","我从九月开始学汉语。现在我正在做作业，有的时候题太多。我希望明天能做完。","Chia sẻ việc học với người mới quen","Nêu mốc bắt đầu và một trải nghiệm học gần đây; em có thể dùng ý riêng."]],
    ...
    hsk2_bai9_tidu:{
      ...
      writing:{
        ...
        tasks:[
          ...
          ["Nhắn tin cho bạn học:\nEm có một câu trong bài tập chưa hiểu. Hãy viết 2–3 câu tiếng Trung hỏi bạn đã làm xong chưa và nhờ bạn giải thích câu đó.","你做完作业了吗？我有一道题不懂。你能帮助我吗？","Hỏi bạn hỗ trợ học tập","Có lời hỏi, nêu điểm chưa hiểu và lời nhờ tự nhiên.",null],
          ["Viết một lời chào mừng ngắn cho một bạn mới vào lớp.","欢迎你来我们班！","Chào đón người mới","Dùng 欢迎 đúng đối tượng.",null],
          ["Nhắn tin cho thầy/cô:\nSau giờ học, em vẫn chưa nghe hiểu một chỗ. Viết 2–3 câu tiếng Trung lịch sự để nói em chưa hiểu và xin thầy/cô nói lại.","老师，刚才有一个地方我没听懂。您能再说一遍吗？谢谢您！","Xin hỗ trợ sau giờ học","Nêu rõ điểm chưa hiểu, lời đề nghị và cách nói lịch sự.","准确 40%: nêu được việc chưa hiểu và lời đề nghị.\n连贯 25%: các ý nối tự nhiên.\n得体 20%: dùng cách xưng hô lịch sự với thầy/cô.\n自然 15%: dùng 听不懂、再说一遍 tự nhiên."]
        ],
