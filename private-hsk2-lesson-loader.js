...
async function boot(){
 ...
 async function load(){
   ...
   // RPC can return either the lesson row, the lesson payload itself, or a one-row JSON array.
   // Let the adapter normalize the boundary instead of assuming one RPC shape.
